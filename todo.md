...
- [x] **P3-6** Integration tests for filtering, pagination, and each summary endpoint (empty month, single category, mixed) — Owner: Adithya
- [x] **Exit:** all read/aggregation endpoints return correct, tested data
...
- [x] **P4-2** Stream CSV with correct headers (`text/csv`, `Content-Disposition`) — Owner: Adithya
- [x] **P4-3** Test content + headers; INR amounts formatted with 2 decimals, no scientific notation — Owner: Adithya
- [x] **Exit:** export downloads a correct CSV for the active filter set
...
- [x] **P5-3** Month selector state (defaults to current month) feeding all queries — Owner: Adithya
...
- [x] **P6-1** "This Month" total card — Owner: Adithya
...
- [x] **P7-4** Delete with confirm prompt — Owner: Adithya
- [x] **P7-5** Component tests: modal validation + edit pre-fill; table rows/actions/empty state — Owner: Adithya
- [x] **Exit:** add/edit/delete work end to end and the dashboard updates live
...
- [x] **P8-3** Export CSV button hitting the export endpoint with current filters — Owner: Adithya
- [x] **P8-4** Component tests: changing filters updates query params — Owner: Adithya
- [x] **Exit:** filtering/search refine list + charts; CSV downloads the filtered set
